 <%
    session.setAttribute("accountNumber", request.getParameter("username")); 
%>
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        ...
                        <form method="post" action="userloginv" class="register-form" id="login-form">
                            <div class="form-group">
                                <label for="username"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="username" id="username" placeholder="Your Account Number" />
                            </div>
                            <div class="form-group">
